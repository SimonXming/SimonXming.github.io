...
![标记 - 清扫](https://upload.wikimedia.org/wikipedia/commons/4/4a/Animation_of_the_Naive_Mark_and_Sweep_Garbage_Collector_Algorithm.gif)
...
![三色标记算法](https://upload.wikimedia.org/wikipedia/commons/1/1d/Animation_of_tri-color_garbage_collection.gif)
...
![三色标记法](http://legendtkl.com/img/uploads/2017/gc.png)
